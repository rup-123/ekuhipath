...
class ParentPaidCourseAdapter(var paidCourseDetails: PaidCourseDetails,var context: Context, private val onVideoClick: (String,String) -> Unit): RecyclerView.Adapter<ParentPaidCourseAdapter.DataViewHolder>() {
    ...
    override fun onBindViewHolder(holder: DataViewHolder, position: Int) {
        ...
        val childPaidCourseAdapter = ChildPaidCourseAdapter(paidCourseDetails.data.chapters[position].videos,context){ videoid,videoname -> onVideoClick(videoid as String,videoname as String) }
