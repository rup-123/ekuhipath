...
class PaidCourseDetailsActivity: AppCompatActivity(), NetworkChangeReceiver.NetworkChangeListener {
    ...
    private fun playVideo(videoid: String,videoname:String,pdfpath:String?) {
        ...
        val video_thumbnail = "https://www.ekuhica.com/api/ekuhipath-v1/video-course/get-video-thumbnail/" +  videoid
                    ...
                    if (response.isSuccessful) {
                        ...
                        if (code == null) {
                            ...
                            if (code.data.video_details.main_video_name.equals("")){
                                ...
                                val videoUrl = "https://www.ekuhica.com/api/ekuhipath-v1/video-course/watch/$subcourseid/$videoid/${code.data.video_details.main_video_name}"
